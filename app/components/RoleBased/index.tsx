...
const RoleBased = () => {
  return (
    <div className='text-center   px-8 relative flex items-center gap-8 md:mt-[200px] mt-[70px]  xl:h-[600px]'>
      {/* LEFT CONTENT */}
      ...
      {/* RIGHT IMAGE */}
      <div className='absolute hidden xl:block top-0 left-[-70px] w-1/2 h-[550px] '>
        <img
          src='/role_based.png'
          alt='contact'
