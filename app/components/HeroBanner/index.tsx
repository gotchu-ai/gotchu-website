...
const HeroBanner = () => {
  ...
  return (
    <section
      className='relative min-h-[589px] w-full overflow-hidden flex items-start pt-[120px] justify-center mt-[100px]'
    ...
    >
      ...
      {[
        ...
        return (
          <motion.div
            key={i}
            className={`absolute ${top} ${left ?? ''} ${right ?? ''}`}
      ...
      <Image
        ...
        height={500}
        src={'/hero/line.png'}
        className='absolute bottom-[150px] left-[10%] z-30'
      />
      ...
      <Image
        ...
        className='absolute bottom-[60px] right-[2%] z-30'
      />
      <Image
        alt='line'
        width={500}
        height={500}
        src={'/hero/lineright.png'}
        className='absolute bottom-[150px] right-[10%] z-30'
      />
    </section>
  );
};
